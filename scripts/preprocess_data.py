...
def parse_annotations(data):
    # Depending on structure, this might be a list of dicts or a single wrapper
    # Adjusting based on ruleset: data['content_clean'] and data['annotations']
...
def align_labels_with_tokens(tokenizer, text, labels, max_len=512, overlap=128):
    # This function handles the sliding window and label alignment
    # Since we need to produce chunks, we will tokenize the whole text first
